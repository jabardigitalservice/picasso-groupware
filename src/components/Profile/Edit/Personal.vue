  ...
  <ValidationObserver tag="div">
    ...
    <div class="form-input-container">
      <FormInput type="date"
                  ...
                  v-model="mData.working_start_date" />
    </div>
    <div class="form-input-container">
